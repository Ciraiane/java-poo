...
class Dog {
    ...
    public String imcc() {
        /*
         * IMCC é dado por uma razão entre o peso (Dog.weight) e o quadrado do tamanho
         * (Dog.size).
         * O resultado então é comparado com valores predeterminados em uma escala, onde
         * IMCC <= 18.5: Abaixo do peso
         * 18.5 < IMCC <= 25.0: Peso normal
         * 25 < IMCC <= 30: Acima do peso
         * IMCC > 30: Obeso
         */
